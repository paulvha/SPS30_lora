...
#if defined (__AVR_ATmega328__) || defined(__AVR_ATmega328P__)|| defined(__AVR_ATmega16U4__) || defined (__AVR_ATmega32U4__)
...
class lora_SPS30
{
  public:
    ...
    */
     ...
     */
    bool begin(serial_port port = SERIALPORT1); //If user doesn't specify Serial1 will be used
